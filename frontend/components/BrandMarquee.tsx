...
export default function BrandMarquee() {
  ...
  return (
    <div aria-hidden="true" className="w-full py-12 glass-panel border-y border-white/10 overflow-hidden relative mt-0">
      ...
      <div className="animate-marquee flex items-center gap-16 whitespace-nowrap">
        {[...marques, ...marques, ...marques].map((marque, idx) => (
          <div key={idx} aria-hidden="true" className="flex items-center gap-16 group cursor-default">
            <span aria-hidden="true" className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold tracking-[0.2em] text-[#C9A227]/70 group-hover:text-[#C9A227] transition-all duration-500 cursor-crosshair">
              {marque}
            </span>
